...
import com.jobportal.dao.dto.JobApplicationResponse;
...
public class JobApplicationResource {
	...
	public JobApplicationResource(ResourceLoader resourceLoader) {
	...
	private Set<String> stopWords = new HashSet<>(Arrays.asList("with", "such", "within", "the", "and", "or", "of", "a", "an", "in"));
	...
	public ResponseEntity<JobApplicationResponse> fetchAllJobApplicationsByJob(int jobId) throws IOException {
